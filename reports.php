...
<legend>',__("Asset Reports"),'</legend>
	...
	<a href="report_contact.php">',__("Asset Report by Owner")." (PDF)",'</a>
	<a href="report_asset.php">',__("Data Center Asset Report")." (PDF)",'</a>
    <a href="report_asset_Excel.php">',__("Data Center Asset Report [Excel]"),'</a>
	<a href="report_cost.php">',__("Data Center Asset Costing Report")." (PDF)",'</a>
	<a href="report_aging.php">',__("Asset Aging Report")." (PDF)",'</a>
	<a href="report_projects.php">',__("Project Asset Report")." (Excel)",'</a>
        <a href="report-projects.php">',__("Project Asset Report"),'</a>
    <a href="report_warranty.php">',__("Warranty Expiration Report")." (PDF)",'</a>
	<a href="report_vm_by_department.php">',__("Virtual Machines by Department")." (PDF)",'</a>
	<a href="report_network_map.php">',__("Network Map"),'</a>
	<a href="report_vendor_model.php">', __("Vendor/Model Report")." (Excel)",'</a>
</fieldset>
</div>
